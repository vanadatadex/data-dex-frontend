"use strict";(self.webpackChunk_vanadex_datadex=self.webpackChunk_vanadex_datadex||[]).push([[822],{80822:(e,t,i)=>{i.r(t),i.d(t,{AppKitModal:()=>ye,W3mModal:()=>ge,W3mModalBase:()=>ve});var o=i(20127),a=i(83597),r=i(82977),s=i(19560),n=i(84575),c=i(91087),l=i(18232),w=i(50426),d=i(10121),p=i(2044),u=i(72594);const h={isUnsupportedChainView:()=>"UnsupportedChain"===p.I.state.view||"SwitchNetwork"===p.I.state.view&&p.I.state.history.includes("UnsupportedChain"),async safeClose(){this.isUnsupportedChainView()||await u.U.isSIWXCloseDisabled()?c.W.shake():c.W.close()}};var m=i(22516),v=i(79967),g=i(13222),y=i(62445),f=i(56269),b=i(40374);const k=o.AH`
  :host {
    display: block;
...
`;var x=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let C=class extends o.WF{render(){return o.qy`<slot></slot>`}};C.styles=[f.W5,k],C=x([(0,b.E)("wui-card")],C);i(78150);var S=i(57239);i(63800),i(7432),i(43170);const W=o.AH`
  :host {
    display: flex;
    align-items: center;
...
//# sourceMappingURL=822.f810ec52.chunk.js.map