...
describe("#anonymizeLink", () => {
  ...
  it("anonymizes any addresses in etherscan urls", () => {
    expect(anonymizeLink("https://etherscan.io/address/0xabcd")).toEqual(
  ...
  it("anonymizes hashes in the middle of the url", () => {
    expect(
      anonymizeLink("https://goerli.etherscan.io/address/0xabcd/test")
    ).toEqual("https://goerli.etherscan.io/address/***/test");
  });
  it("does not anonymize 0x", () => {
    expect(
      anonymizeLink("https://goerli.etherscan.io/address/0x/test")
    ).toEqual("https://goerli.etherscan.io/address/0x/test");
  });
  it("works for arbitrum urls", () => {
    expect(anonymizeLink("https://arbiscan.io/0x/0xabc")).toEqual(
      "https://arbiscan.io/0x/***"
    );
  });
});
