import { ChainId, Percent } from "@vanadex/sdk-core";
import { WETH_ADDRESS as getWethAddress } from "@vanadex/universal-router-sdk";
...
function useFeeOnTransferDetectorContract(): FeeOnTransferDetector | null {
  return useContract<FeeOnTransferDetector>(
